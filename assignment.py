...
number_one = 45
number_two = 17
total_50 = number_one + number_two
# TASK 13:
...
days_worked = 5
weekly_pay = daily_pay * days_worked
...
week_in_month = 4
monthly_pay = week_in_month * weekly_pay
...
# and one number.
months_in_year = 12
yearly_pay = months_in_year * monthly_pay
...
print(user_name + "like" + favorite_food)
...
first_user_number = input("Enter a whole number.")
...
#
# second_user_number
second_user_number = input("Enter another whole number.")
...
#
# work_hours
work_hours = input("How many hours do you work in onr day?")
...
hourly_rate = input("How much do you get paid an hour?")
...
money_spent = input("How much money have you spent?")
...
# approximate_age
approximate_age = 2026 - int(birth_year)
...
number3 = input("Give me another number.")
...
#
# in this calculation.
final_answer = doubled_average - int(number1)
